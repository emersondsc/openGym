...
export default {
  ...
  'Edit mesocycle': 'Editar mesociclo',
  ...
  'Active': 'Ativo',
  'Not active': 'Inativo',
  'Active since {0}': 'Ativo desde {0}',
  'activated by the assistant': 'ativado pelo assistente',
  'activated by you': 'ativado por você',
  ...
  'RULES': 'REGRAS',
  'EVIDENCE': 'EVIDÊNCIA',
  'Why this mesocycle': 'Por que este mesociclo',
  'COACH LOG': 'HISTÓRICO DO COACH',
  'entries': 'registros',
  'Lower': 'Inferior',
  'Upper': 'Superior',
  'EXTRAS': 'EXTRAS',
  ...
  'Show all ({0})': 'Ver todas ({0})',
  'Show less': 'Ver menos',
  'Import mesocycle': 'Importar mesociclo',
  'Weeks': 'Semanas',
  'Rules': 'Regras',
  'Extras': 'Extras',
  'Replace': 'Substituir',
  'Activate it now?': 'Ativar agora?',
  'Activate': 'Ativar',
  ...
  '{0} deleted. No active mesocycle.': '{0} eliminado. Ficaste sem mesociclo ativo.',
  'It leaves your library, here and on your other devices. This cannot be undone.': 'Sai da tua biblioteca, aqui e nos teus outros aparelhos. Não pode ser anulado.',
  'This is your active mesocycle. Nothing is active after this, and it cannot be undone.': 'Este é o teu mesociclo ativo. Depois disto não fica nenhum ativo, e não pode ser anulado.',
  'Create mesocycle': 'Criar mesociclo',
  'Name': 'Nome',
  'Starts on': 'Começa em',
  'Objective': 'Objetivo',
  'Focus lower': 'Foco inferior',
  'Focus upper': 'Foco superior',
  'Target reps': 'Reps alvo',
  'Phase of each week': 'Fase de cada semana',
  'One line: what this block is for': 'Uma linha: para que serve este bloco',
  'Four fields are enough. Everything else can come later, and nothing here rewrites what the coach wrote.': 'Quatro campos bastam. O resto pode vir depois, e nada aqui reescreve o que o coach escreveu.',
  'Fill the name and the date (AAAA-MM-DD)': 'Preencha o nome e a data (AAAA-MM-DD)',
  ...
  'Could not read that file': 'Não consegui ler esse arquivo',
  'Import': 'Importar',
  ...
  'Weight-room industrial: hard corners, uppercase, safety orange.': 'Academia industrial: cantos secos, caixa-alta, laranja de segurança.',
  'Modern app: deep navy, big corners, one gradient on the action.': 'App moderno: azul-noite, cantos grandes, um gradiente só na ação.',
  'Calm and minimal: deep green, more air, no noise.': 'Calmo e minimal: verde profundo, mais ar, sem ruído.',
  'Grind brings its own colours and dark mode, so those controls are hidden.': 'O estilo Grind traz as suas próprias cores e o seu modo escuro, por isso estes controlos estão escondidos.',
  'Pulse brings its own colours and dark mode, so those controls are hidden.': 'O estilo Pulse traz as suas próprias cores e o seu modo escuro, por isso estes controlos estão escondidos.',
  'Sage brings its own colours and light mode, so those controls are hidden.': 'O estilo Sage traz as suas próprias cores e o seu modo claro, por isso estes controlos estão escondidos.',
  ...
  'Same as your profile ({0})': 'Igual à do teu perfil ({0})',
  ...
  'Rest time': 'Tempo de descanso',
  'Default': 'Padrão',
  'Use the global rest setting': 'Usa o tempo de descanso global das definições',
  'Use the routine rest setting': 'Usa o tempo da rotina',
  'Rest saved for {0} — {1}s': 'Descanso salvo para {0} — {1}s',
  'Rest reset to default': 'Descanso redefinido para padrão',
  ...
  'Weekly volume': 'Volume semanal',
  'planned': 'planejado',
  'done': 'feito',
  '{0} of {1} sets': '{0} de {1} séries',
  '{0} of {1} workouts': '{0} de {1} treinos',
  'Weekly volume, {0} of {1} workouts done — open Plan': 'Volume semanal, {0} de {1} treinos feitos — abrir Plano',
  'Weekly volume done, {0} workouts — open Plan': 'Volume semanal feito, {0} treinos — abrir Plano',
  'No plan this week yet.': 'Sem plano nesta semana.',
  '+{0} more': '+{0} mais',
  'Weekly volume planned, {0} workouts planned — open Plan': 'Volume semanal planejado, {0} treinos planejados — abrir Plano',
  'No plan this week yet. — open Plan': 'Sem plano nesta semana. — abrir Plano',
