...
- **Status:** **RESOLVIDO em 11/09/2026** (commits `6a8c3f2`, `b8a5d47` e `f2e1c09` na branch `emerson-custom`; no ar nos containers `opengym-api-1` e `opengym-web-1`). Texto reescrito em 11/09/2026 com a análise fresca do que existe hoje; implementado no mesmo dia.
